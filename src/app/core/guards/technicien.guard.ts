...
export class TechnicieneGuard implements CanActivate {
  ...
  canActivate(): boolean {
    ...
    const isAgence = this.authService.isTechnicien(); // Assuming you have a method in AuthService to check if the user is an admin
