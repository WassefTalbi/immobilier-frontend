...
export class VerificateurGuard implements CanActivate {
  ...
  canActivate(): boolean {
    ...
    const isUser = this.authService.isVerificateur(); // Assuming you have a method in AuthService to check if the user is an admin
